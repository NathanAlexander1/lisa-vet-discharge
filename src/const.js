export const vaccineInfo = [
  {
    ...
    nextDueYrs: "1",
    blurb: "heShe This is the blurb about Rabies Vaccine (1 yr)!",
  },
  {
    service: "Rabies Vaccine (3 yr)",
    nextDue: "3 years from when vaccine was administered",
    nextDueYrs: "3",
    blurb: "This is the blurb about Rabies Vaccine (3 yr)!",
  },
  {
    service: "Pure Vax Rabies (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about Pure Vax Rabies (1 yr)!",
  },
  {
    service: "FVRCP (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about FVRCP (1 yr)!",
  },
  {
    ...
    nextDueYrs: "",
    booster: "3-4 weeks",
    blurb: "This is the blurb about FVRCP (booster)!",
  },
  {
    service: "FVRCP (3 yr)",
    nextDue: "3 years from when vaccine was administered",
    nextDueYrs: "3",
    blurb: "This is the blurb about FVRCP (3 yr)!",
  },
  {
    service: "Bordatella (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about Bordatella (1 yr)!",
  },
  {
    service: "FeLV (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about FeLV (1 yr)!",
  },
  {
    ...
    nextDueYrs: "",
    booster: "3-4 weeks",
    blurb: "This is the blurb about FeLV (booster)!",
  },
  {
    service: "DHPP (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about DHPP (1 yr)!",
  },
  {
    ...
    nextDueYrs: "",
    booster: "3-4 weeks",
    blurb: "This is the blurb about DHPP (booster)!",
  },
  {
    service: "DHPP (3yr)",
    nextDue: "3 years from when vaccine was administered",
    nextDueYrs: "3",
    blurb: "This is the blurb about DHPP (3yr)!",
  },
  {
    service: "Lepto (1 yr)",
    nextDue: "1 year from when vaccine was administered",
    nextDueYrs: "1",
    blurb: "This is the blurb about Lepto (1 yr)!",
  },
  {
    ...
    nextDueYrs: "",
    booster: "3-4 weeks",
    blurb: "This is the blurb about Lepto (booster)!",
  },
];
...
export const standardServicesInfo = [
  ...
  },
  {
    ...
    blurb:
      ...
      htmlBlurb: (
        <>
          <p>petName also received a dose of oral deworming medication during this appointment. We have sent home an additional dose of this same medication which should be given in 14 days. Please give the provided dose by mouth as instructed on the label.
          </p>
        </>
      ),
  },
  ...
  },
  {
    ...
    blurb:
      ...
      htmlBlurb: <><p>Microchipping is also available through the wellness clinic. Microchipping is minimally invasive and makes it easy for others to identify your pet if they are lost. Each chip number is unique and is registered with a national database. This number links to your address and phone number. Most animal organizations and veterinary clinics have the ability to scan and read microchips and will notify you if heShe is ever found. Please let us know if you would like this service performed at your next wellness appointment.</p></>
  ...
  },
  {
    ...
    blurb:
      ...
      htmlBlurb: <><p>petName has a microchip registered with MCCOMPANYNAME. The microchip number is ###.  Please contact MCCOMPANYNAME directly to make any necessary changes to the microchip information.</p></>
  },
  {
    ...
    htmlBlurb: (
      <>
        <p>
          An FeLV / FIV test was performed. The results are heShe listed below:
        </p>
        <ul>
          <li>FeLV results: Negative</li>
          <li>FeLV results: Negative</li>
        </ul>
        <p>Following exposure to either virus, it can take 1 to 3 months for an infection to develop. One negative test for FELV or FIV does not guarantee that a cat is truly negative. Due to lag time between a potential initial infection and the development of positive test results, retesting for confirmation of negative FIV and FeLV status may be recommended in the future.</p>
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    blurb:
      ...
      htmlBlurb: <><p>As heShe continues to age, you may consider starting to brush his/her teeth using toothpaste formulated for pets. If this is not possible, adding some dental treats, dental wipes or gel daily can help with this as well. Your pet may eventually need a dental procedure done but keeping up on oral care may help prolong the time until this is needed. You can check out the VOHC.org website for dentist approved treats and toys.</p></>
