...
export const standardServicesInfo = [
  ...
  {
    service: "Leptospirosisspirosis",
    blurb:
      "In addition to rabies, DHPP and bordetella vaccines, we also carry a vaccine for Leptospirosisspirosis. This is a bacterial disease that can be deadly and mainly affects the liver and kidneys. This disease is transmitted through urine of wild animals, mainly rodents such as rats, which contaminate water sources in the environment. We can start this vaccine at age 12 weeks. Your pet will need to have a second booster 3-4 weeks after the initial vaccine in order to be considered fully vaccinated for a year. After the initial vaccine series, your pet will only need one Leptospirosisspirosis vaccine a year to continue being covered for this disease. Please let us know if you would be interested in having this vaccine administered in the future. For more information about Leptospirosisspirosis- please see: https://www.avma.org/resources/pet-owners/petcare/Leptospirosisspirosis",
      domBlurb: "<p>In addition to rabies, DHPP and bordetella vaccines, we also carry a vaccine for Leptospirosisspirosis. This is a bacterial disease that can be deadly and mainly affects the liver and kidneys. This disease is transmitted through urine of wild animals, mainly rodents such as rats, which contaminate water sources in the environment. We can start this vaccine at age 12 weeks. Your pet will need to have a second booster 3-4 weeks after the initial vaccine in order to be considered fully vaccinated for a year. After the initial vaccine series, your pet will only need one Leptospirosisspirosis vaccine a year to continue being covered for this disease. Please let us know if you would be interested in having this vaccine administered in the future. For more information about Leptospirosisspirosis- please visit: https://www.avma.org/resources/pet-owners/petcare/Leptospirosisspirosis</p>"
  },
  {
