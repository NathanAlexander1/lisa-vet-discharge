...
export const standardServicesInfo = [
  {
    ...
    },
    {
        ...
        blurb: "XXX has a microchip registered with (MC COMPANY NAME). The microchip number is ###.  Please contact (MC COMPANY NAME) directly to make any necessary changes to the microchip information."
    },
    {
